                ...
                <div className="p-6">
                  ...
                  <div className="mb-4">
                    <div className="flex justify-between text-sm text-gray-600 mb-1">
                      ...
                      <span>{event.registered_count || 0} / {event.max_participants || 100}</span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div
                        className="bg-red-600 h-2 rounded-full"
                        style={{ width: `${Math.min(((event.registered_count || 0) / (event.max_participants || 100)) * 100, 100)}%` }}
                      />
                    </div>
                  </div>

                  {event.status === 'upcoming' && (event.registered_count || 0) < (event.max_participants || 100) ? (
                    <button
